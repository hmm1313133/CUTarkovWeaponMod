...
/// <summary>
/// Strike Industries Cobra 战术前握把【Cobra】。
/// 效果：后坐力 -0.5%（knockBack × 0.995）、开镜速度 -0.27 秒（AimSystem）。
/// </summary>
public static class CobraForegripItemSystem
{
    public const string ItemKey = "cobra";
    public const string BaseGameItemId = "bruisekit";

    public static string DisplayName => I18n.Tr("foregrip_cobra.name");
    public static string Description => I18n.Tr("foregrip_cobra.desc");
    ...
    private static Sprite? TryLoadIcon()
    {
        ...
        var tex = TacticalLightHelper.LoadPointIconTexture("guns/common/cobra.png");
        if (tex != null)
        {
            _cachedIcon = Sprite.Create(tex,
                new Rect(0, 0, tex.width, tex.height),
                new Vector2(0.5f, 0.5f), 14f);
            _cachedIcon.name = "cobra-icon";
        }
        return _cachedIcon;
    }
