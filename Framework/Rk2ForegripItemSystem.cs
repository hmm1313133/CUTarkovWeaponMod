...
/// <summary>
/// Zenit RK-2 前握把【RK-2】。
/// 效果：后坐力 -4.5%（knockBack × 0.955）、开镜速度 +0.1 秒（略减慢，AimSystem）。
/// </summary>
public static class Rk2ForegripItemSystem
{
    public const string ItemKey = "rk2";
    public const string BaseGameItemId = "bruisekit";

    public static string DisplayName => I18n.Tr("foregrip_rk2.name");
    public static string Description => I18n.Tr("foregrip_rk2.desc");

    public const float KnockBackMult = 0.955f; // 后坐力 -4.5%
    ...
    private static Sprite? TryLoadIcon()
    {
        ...
        var tex = TacticalLightHelper.LoadPointIconTexture("guns/common/rk2.png");
        if (tex != null)
        {
            _cachedIcon = Sprite.Create(tex,
                new Rect(0, 0, tex.width, tex.height),
                new Vector2(0.5f, 0.5f), 14f);
            _cachedIcon.name = "rk2-icon";
        }
        return _cachedIcon;
    }
