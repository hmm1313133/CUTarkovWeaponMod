...
/// <summary>
/// RTM Pillau P-2 战术前握把（红色）【P-2】。
/// 效果：后坐力 -1%（knockBack × 0.99）、开镜速度 -0.08 秒（AimSystem）。
/// </summary>
public static class P2ForegripItemSystem
{
    public const string ItemKey = "p2";
    public const string BaseGameItemId = "bruisekit";

    public static string DisplayName => I18n.Tr("foregrip_p2.name");
    public static string Description => I18n.Tr("foregrip_p2.desc");
    ...
    private static Sprite? TryLoadIcon()
    {
        ...
        var tex = TacticalLightHelper.LoadPointIconTexture("guns/common/p_2.png");
        if (tex != null)
        {
            _cachedIcon = Sprite.Create(tex,
                new Rect(0, 0, tex.width, tex.height),
                new Vector2(0.5f, 0.5f), 14f);
            _cachedIcon.name = "p2-icon";
        }
        return _cachedIcon;
    }
