...
/// <summary>
/// STARK SE-5 Express 战术握把【SE-5】。
/// 效果：后坐力 -1%（knockBack × 0.99）、开镜速度 -0.22 秒（AimSystem）。
/// </summary>
public static class Se5ForegripItemSystem
{
    public const string ItemKey = "se5";
    public const string BaseGameItemId = "bruisekit";

    public static string DisplayName => I18n.Tr("foregrip_se5.name");
    public static string Description => I18n.Tr("foregrip_se5.desc");
    ...
    private static Sprite? TryLoadIcon()
    {
        ...
        var tex = TacticalLightHelper.LoadPointIconTexture("guns/common/se5.png");
        if (tex != null)
        {
            _cachedIcon = Sprite.Create(tex,
                new Rect(0, 0, tex.width, tex.height),
                new Vector2(0.5f, 0.5f), 14f);
            _cachedIcon.name = "se5-icon";
        }
        return _cachedIcon;
    }
