...
/// <summary>
/// Magpul AFG 斜角前握把（黑色）【AFG】。
/// 效果：后坐力 -2%（knockBack × 0.98）、开镜速度 -0.1 秒（AimSystem）。
/// </summary>
public static class AfgForegripItemSystem
{
    public const string ItemKey = "afg";
    public const string BaseGameItemId = "bruisekit";

    public static string DisplayName => I18n.Tr("foregrip_afg.name");
    public static string Description => I18n.Tr("foregrip_afg.desc");
    ...
    private static Sprite? TryLoadIcon()
    {
        ...
        var tex = TacticalLightHelper.LoadPointIconTexture("guns/common/AFG.png");
        if (tex != null)
        {
            _cachedIcon = Sprite.Create(tex,
                new Rect(0, 0, tex.width, tex.height),
                new Vector2(0.5f, 0.5f), 14f);
            _cachedIcon.name = "afg-icon";
        }
        return _cachedIcon;
    }
