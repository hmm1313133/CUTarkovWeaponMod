...
/// <summary>
/// Zenit RK-1 B-25U 基座前握把【B-25U RK-1】。
/// 效果：后坐力 -3.7%（knockBack × 0.963）、开镜速度 -0.15 秒（AimSystem）。
/// </summary>
public static class B25ur1ForegripItemSystem
{
    public const string ItemKey = "b25ur1";
    public const string BaseGameItemId = "bruisekit";

    public static string DisplayName => I18n.Tr("foregrip_b25ur1.name");
    public static string Description => I18n.Tr("foregrip_b25ur1.desc");

    public const float KnockBackMult = 0.963f; // 后坐力 -3.7%
    ...
    private static Sprite? TryLoadIcon()
    {
        ...
        var tex = TacticalLightHelper.LoadPointIconTexture("guns/common/b-25u rk-1.png");
        if (tex != null)
        {
            _cachedIcon = Sprite.Create(tex,
                new Rect(0, 0, tex.width, tex.height),
                new Vector2(0.5f, 0.5f), 14f);
            _cachedIcon.name = "b25ur1-icon";
        }
        return _cachedIcon;
    }
