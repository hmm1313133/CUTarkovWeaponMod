...
public static class Ssh68ItemSystem
{
    public const string ItemKey = "ssh68";
    public const string BaseGameItemId = "bruisekit";
    public const string WearSlotId = "hat";

    public static string DisplayName => I18n.Tr("ssh68.name");
    public static string Description => I18n.Tr("ssh68.desc");

    private static Sprite? _cachedIcon;
    private static Sprite? _cachedWornIcon;

    public static bool IsSsh68Request(MedicalGrantRequest request)
    ...
    public static void ConfigureSpawnedItem(Item item, MedicalGrantRequest request)
    {
        ...
        else { Plugin.Log.LogWarning("[SSh-68] Icon load failed."); }
        ResizeColliderToSprite(item);
        Plugin.Log.LogInfo($"[SSh-68] Configured spawned item '{ItemKey}'.");
    }
    ...
    public static bool EnsureRegisteredInItemTable()
    {
        ...
        try
        {
            ...
            Plugin.Log.LogInfo($"[SSh-68] Registered '{ItemKey}' as wearable helmet.");
            return true;
        }
        catch (Exception ex) { Plugin.Log.LogError($"[SSh-68] Failed: {ex}"); return false; }
    }
    ...
    public static void RegisterWithCUCoreLib(CustomItemInfo customInfo)
    {
        ...
        Plugin.Log.LogInfo($"[SSh-68] CUCoreLib: WornSprite={customInfo.WornSprite != null}, Icon={customInfo.Icon != null}.");
    }
    ...
    private static Sprite? TryLoadIcon()
    {
        ...
        try
        {
            ...
            var iconPath = Path.Combine(assemblyDir, "Framework", "Assets", "equipment", "ssh68.png");
            if (File.Exists(iconPath))
            {
                ...
                _cachedIcon.name = "ssh68-icon";
            }
        }
        catch (Exception ex) { Plugin.Log.LogWarning($"[SSh-68] Icon: {ex.Message}"); }
        return _cachedIcon;
    }
    ...
    private static Sprite? TryLoadWornIcon()
    {
        ...
        try
        {
            ...
            if (File.Exists(iconPath))
            {
                ...
                _cachedWornIcon.name = "ssh68-worn";
            }
        }
        catch (Exception ex) { Plugin.Log.LogWarning($"[SSh-68] Worn: {ex.Message}"); }
    ...
    public static class Ssh68HoverPatch
    {
        [HarmonyPostfix]
