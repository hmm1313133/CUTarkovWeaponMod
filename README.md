...
| 10 个自定义弹匣 | 弹匣供弹枪械的专属弹匣，可合成、世界生成 |
...
| 10 | 6LBT-2670 SFMP | `6lbt2670` | 2.5 | 45 | 14.0u | 60% | 医疗专用、约7小时衰减 |
...
| 位置 | 枪械 | 弹匣 | 近战 | 护甲/弹挂 | 头盔 | 背包 |
|------|------|------|------|---------|------|------|
| 物资箱 | 18.6% | 22% | 13%（40%冰镐 / 60%M2） | 17% | 17% | 13%(1~2个) |
| 空投舱 | 20% | - | - | 25% | 20% | 6% |
| 空投胶囊 | 29% | - | - | 32%（弹挂类） | 17%(1~2个) | 16% |
| 尸体旁 | 15% | 15% | - | 7% | 5% | 3% |
| 崩溃舱 | - | 62%（替换） | - | - | - | - |
| 医疗箱 | - | - | - | 20% | - | - |
